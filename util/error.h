...
#define MU_PUSH_ERRF(x, y, ...) push_errf(x, __FILE__, __func__, __LINE__, -1, y, __VA_ARGS__)
...
extern void push_error(struct mu_error **list, const char *file, const char *func, uint_least16_t line, const char *errmsg, int ret);
extern void push_errf(struct mu_error **list, const char *file, const char *func, uint_least16_t line, int ret, const char *fmt, ...);
